...
/**** CALENDARIO ****/
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (1, 4, '2010-08-10 12:00:00', '2010-08-10 18:00:00', 1);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (2, 4, '2010-08-10 14:00:00', '2010-08-10 17:00:00', 1);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (3, 18, '2010-09-10 02:00:00', '2010-08-10 08:00:00', 2);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (4, 18, '2010-09-10 03:00:00', '2010-08-10 09:00:00', 2);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (5, 18, '2010-09-10 04:00:00', '2010-09-10 10:00:00', 2);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (6, 14, '2010-08-10 02:00:00', '2010-08-10 08:00:00', 3);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (7, 14, '2010-08-10 09:00:00', '2010-08-10 23:00:00', 3);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (8, 12, '2010-08-10 08:00:00', '2010-08-10 20:00:00', 4);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (9, 12, '2010-08-10 09:00:00', '2010-08-10 20:00:00', 4);
insert into calendario (ID, DURACION, FECHA_HORA_SALIDA, FECHA_HORA_LLEGADA, SALIDA_ID) values (10, 12, '2010-08-10 10:00:00', '2010-08-10 18:00:00', 4);
