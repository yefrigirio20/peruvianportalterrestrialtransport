                                    ...
                                    <td>
                                     ...
                                     <table border="0" width="100%" bgcolor="white">
                                          <tr>
                                             ...
                                             <center> <font color="#FFFFFF"> <strong>Bus x Empresa</strong></font> 
                                               </center>
                                             </td>
                                          </tr> 
                                          ...
                                          <tr> 
                                            ...
                                            <td width="60%">Cruz del Sur</td> 
                                          </tr> 
                                           
                                          <tr> 
                                            <td width="40%"><strong>Servicio:</strong></td>
                                            <td width="60%">1000</td> 
                                          </tr> 
                                          
                                          <tr> 
                                            <td width="100%" colspan="2" align="center">                                               
                                               <img src="../imagenes/CruzDelSur2.png" width="400" height="220" >
                                            </td> 
                                          </tr> 
